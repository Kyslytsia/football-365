export const roundOf16Lines = [
  ...
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
    style: { top: 110, left: "27%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] h-[2px]",
    style: { top: 110, left: 54, width: "24.2%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
    style: { top: 110, right: "27%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] h-[2px]",
    style: { top: 110, right: 55, width: "23.9%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
    style: { bottom: 90, left: "15%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
    style: { bottom: 90, left: "38.9%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
    style: { bottom: 90, left: "60.5%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
  ...
  {
    className: "absolute bg-[#a6b8c9] z-[1] h-[2px]",
    style: { bottom: 110, right: 54, width: "24.5%" },
  },
];

export const quarterFinalsLines = [
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
  ...
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
    style: { top: 199, left: "72.5%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] h-[2px]",
    style: { top: 217, left: 98, width: "45.5%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
  ...
  {
    className: "absolute bg-[#a6b8c9] z-[1] w-[2px] h-[20px]",
    style: { bottom: 201, left: "72.5%" },
  },
  {
    className: "absolute bg-[#a6b8c9] z-[1] h-[2px]",
    style: { bottom: 219, left: 98, width: "45.5%" },
  },
];
