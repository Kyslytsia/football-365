      ...
      <View className="relative flex flex-col pb-[30px]">
        ...
        >
          {penalty.length !== 0 && (
            <View>
              <Text className={styles.eventText}>
                penalty {matchData?.score.penalty.home?.toString()}
                <Text> - </Text>
                {matchData?.score.penalty.away?.toString()}
              </Text>
          ...
          {isExtra && (
            <View>
              <Text className={styles.eventText}>
                extra time {matchData?.goals.home?.toString() ?? "0"}
                <Text> - </Text>
                {matchData?.goals.away?.toString() ?? "0"}
              </Text>
          ...
          <View>
            <Text className={styles.eventText}>
              full time {matchData?.goals.home?.toString()}
              <Text> - </Text>
          ...
          <View>
            <Text className={styles.eventText}>
              first half {matchData?.score.halftime.home.toString()}
              <Text> - </Text>
              {matchData?.score.halftime.away.toString()}
            </Text>
