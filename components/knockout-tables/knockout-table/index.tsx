...
import { roundOf16Lines, quarterFinalsLines } from "./lineClasses";
    ...
    return (
      <ScrollView>
        <View className="relative">
          ...
          <View className="relative gap-y-12 py-5 mx-auto w-[360px] z-10">
            ...
            <View className={`${roundWrapperStyle} w-[235px]`}>
              {isNational ? (
                <>
